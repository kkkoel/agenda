...
#ifdef _WIN32
    _mkdir("/home/code/Desktop/MySchedule/data");
#else
    mkdir("/home/code/Desktop/MySchedule/data", 0755);
#endif
}
...
bool registerUser(const string& username, const string& password) {
    ...
    if (!fout.is_open()) {
        cerr << "[ERROR] Cannot open " << USER_FILE << " for writing\n";
        return false;
    }
